...
{
    public class GetUserBestStreaksQueryHandlerShould
    {
        [Theory]
        [AutoMoqData]
        public async Task ReturnAllQuestionsWhenSuccessful(
            GetUserBestStreaksQuery query,
            ...
            [Frozen] Mock<IPlayersRepository> playersRepositoryMock)
        {
            ...
            GetUserBestStreaksQueryHandler sut = new GetUserBestStreaksQueryHandler(triviaGamesRepositoryMock.Object, playersRepositoryMock.Object);
